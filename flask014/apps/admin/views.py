...
from apps import app, db, musicAudiosSet, musicCoversSet, musicLrcsSet, photosSet
...
from apps.models import Admin, ArticleTag, Article, AlbumTag, Album, User, AlbumFavor, ArticleFavor, \
    MusicLangTag, MusicStyleTag, MusicThemeTag, MusicEmotionTag, MusicSceneTag, Music, MusicComment
