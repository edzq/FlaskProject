...
from apps import app, db, photosSet, imgsSet, filesSet, musicCoversSet, musicLrcsSet, musicAudiosSet
...
from apps.home.forms import LoginForm, RegistForm, PwdForm, InfoForm, AlbumInfoForm, AlbumSelectForm, PhotoAddForm, \
    ArticleInfoForm, ArticleWriteForm, MusicCommentForm
from apps.models import User, Album, Photo, AlbumTag, AlbumFavor, ArticleTag, Article, ArticleFavor, MusicLangTag, \
    MusicStyleTag, MusicThemeTag, MusicEmotionTag, MusicSceneTag, Music, MusicFavor, MusicComment
